...
# version_2017_3_21(每个数据包发送时都会进行pattern的选择)

# version_2017_3_25(完善了城镇场景下对于路径损耗类型的判断)

# version_2017_3_26(将SINR计算中的信道部分删去以加快程序运行速度，同时将城区道路下的隔建筑通信默认为丢包)
...
# version_2017_3_28(删除小尺度切换开关)

# version_2017_3_28(删除小尺度切换开关配置文件)

# version_2017_3_30(增加了资源分配方案中的时域随机部分，默认108个T-RPTS)